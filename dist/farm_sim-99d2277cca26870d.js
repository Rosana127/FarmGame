 ...
 * @param {number} col
 */
export function harvest(row, col) {
    wasm.harvest(row, col);
}
 ...
 * @returns {string}
 */
export function get_state(row, col) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_state(row, col);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_adapter_21(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4fea70cde91ddb21(arg0, arg1);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('farm_sim_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
